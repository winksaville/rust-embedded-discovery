...
fn main() -> ! {
    ...
    // magnetometer
    {
        ...
        // Send the address of IRA_REG_M register in MAGNETOMETER we want to read
        i2c1.txdr.write(|w| {
            w.txdata().bits(IRA_REG_M)
        });
        wait_tc_1();
    }
    ...
    iprintln!(&mut itm.stim[0], "txis={} tc={} rxne={}", wait_txis_1_counter, wait_tc_1_counter, wait_rxne_1_counter);
